...
!function(t) {
    ...
    function H(t, b, o) {
        ...
        function Y(t, e) {
            e.handle && (gt(e.handle, b.cssClasses.active),
            g -= 1),
            e.listeners.forEach(function(t) {
                E.removeEventListener(t[0], t[1])
            }),
            0 === g && (gt(h, b.cssClasses.drag),
            et(),
        ...
        function I(t, e) {
            ...
            1 < u.length && mt(h, b.cssClasses.drag),
        ...
        function n(t) {
            t.stopPropagation();
            var i, o, s, e = B(t.calcPoint), r = (i = e,
            s = !(o = 100),
            ...
            if (!1 === r)
                return !1;
            b.events.snap || ft(h, b.cssClasses.tap, b.animationDuration),
            rt(r, e, !0, !0),
            et(),
            J("slide", r, !0),
            J("update", r, !0),
        ...
        return mt(e = h, b.cssClasses.target),
        ...
        a = {
            destroy: function() {
                for (var t in G(bt.aria),
                G(bt.tooltips),
                b.cssClasses)
                    b.cssClasses.hasOwnProperty(t) && gt(h, b.cssClasses[t]);
                for (; h.firstChild; )
